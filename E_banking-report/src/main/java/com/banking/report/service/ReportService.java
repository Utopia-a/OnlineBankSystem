...
public class ReportService {
    ...
    public TransactionDTO getTransactionDetail(String transactionNo, Long userId) {
        TransactionRecord tx = transactionRepository.findByTransactionNo(transactionNo)
    ...
    public AccountStatDTO getAccountStat(Long accountId, LocalDateTime startTime,
        ...
        AccountSummary account = accountRepository.findById(accountId)
    ...
    public ExportInfo exportExcel(Long accountId, TransactionQueryRequest req,
        ...
        List<TransactionRecord> records = fetchForExport(accountId, req);
    ...
    private List<TransactionRecord> fetchForExport(Long accountId, TransactionQueryRequest req) {
        ...
        List<TransactionRecord> records = transactionRepository.findForExport(
    ...
    private void validateAccountOwnership(Long accountId, Long userId) {
        ...
        if (!accountRepository.existsByIdAndUserId(accountId, userId)) {
            ...
            AccountSummary acc = accountRepository.findById(accountId).orElse(null);
            if (acc == null) {
    ...
    private TransactionDTO enrichWithAccountNo(TransactionDTO dto) {
        if (dto.getFromAccountId() != null) {
            accountRepository.findById(dto.getFromAccountId())
                    .ifPresent(a -> dto.setFromAccountNo(a.getAccountNo()));
        }
        if (dto.getToAccountId() != null) {
            accountRepository.findById(dto.getToAccountId())
                    .ifPresent(a -> dto.setToAccountNo(a.getAccountNo()));
        }
        return dto;
    }
